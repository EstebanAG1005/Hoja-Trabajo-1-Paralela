...
double trapezoides(double (*func)(double), double a, double b, int n, int threads)
{
    ...
    // Arreglo para almacenar el resultado de cada thread
    double local_results[threads];
...
#pragma omp parallel num_threads(threads)
    {
        ...
        // Guardar el resultado local en el arreglo
        local_results[ID] = local_result;
    }

    // Sumar todos los resultados locales
